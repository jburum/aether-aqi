...
| [PRODUCT.md](./PRODUCT.md) | UX, roadmap, map |
| [IOS-APP-STORE.md](./IOS-APP-STORE.md) | Free App Store plan (Capacitor) |
| [CHANGELOG.md](./CHANGELOG.md) | Ship history (newest first) |
| [../README.md](../README.md) | Repo root overview |

## Current product snapshot (v1.5.0)

- Up to **15** saved locations, order on-device
- Expand cards → hour / day forecast (12h labels)
- **Map tab** with AQI pins for watchlist places
